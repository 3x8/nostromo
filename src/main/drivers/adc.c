...
void adcRead(void) {
  #if (defined(WRAITH32) || defined(WRAITH32V2) || defined(TYPHOON32V2) || defined(FURLING45MINI) || defined(SUCCEX50AV2) || defined(RAZOR32V2) || defined(TEKKO32MINI45A4X1))
    adcRaw.voltage = adcDmaBuffer[0];
    adcRaw.current = adcDmaBuffer[1];
    adcRaw.temperature = adcDmaBuffer[2];
  #endif

  #if (defined(WRAITH32MINI) || defined(SUCCEXMINI40A) || defined(TEKKO32MINI45A4X1))
