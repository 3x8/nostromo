...
#define TIMER1_INIT_PERIOD  983 // max linearity //797~30.03kHz //911~26.31kHz //977~24.4kHz //997~24.1kHz
...
#define USART_RX_PIN                    LL_GPIO_PIN_15
#define USART_RX_GPIO_PORT              GPIOA
#define USART_RX_GPIO_CLK               LL_AHB1_GRP1_PERIPH_GPIOA
#define USART_RX_AF                     LL_GPIO_AF_1

#define USART_TDR_ADDRESS               0x40004428
#define USART_RDR_ADDRESS               0x40004424
