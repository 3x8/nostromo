...
#define TIMER1_INIT_PERIOD  977 //797~30.03kHz //911~26.31kHz //997~24.1kHz
...
#define LED_RED_PERIPHERAL LL_AHB1_GRP1_PERIPH_GPIOA

// PB3  --- LED GREEN ,Ok
#define LED_GREEN_GPIO       GPIOB
#define LED_GREEN_PIN        GPIO_PIN_3
#define LED_GREEN_PERIPHERAL LL_AHB1_GRP1_PERIPH_GPIOB

// PB4  --- LED BLUE ,Ok
#define LED_BLUE_GPIO       GPIOB
#define LED_BLUE_PIN        GPIO_PIN_4
#define LED_BLUE_PERIPHERAL LL_AHB1_GRP1_PERIPH_GPIOB
...
#define GPIO_PIN_VOLTAGE         GPIO_PIN_6
#define ADC_CURRENT              ADC_CHANNEL_3
#define GPIO_PIN_CURRENT         GPIO_PIN_3
