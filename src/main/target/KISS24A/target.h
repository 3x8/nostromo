...
#define COMPARATOR_PHASE_A_CSR  COMP_CSR_COMP2EN | COMP_CSR_COMP2INSEL_2
#define COMPARATOR_PHASE_B      COMP_INVERTINGINPUT_IO1
#define COMPARATOR_PHASE_B_CSR  COMP_CSR_COMP2EN | COMP_CSR_COMP2INSEL_2 | COMP_CSR_COMP2INSEL_1
#define COMPARATOR_PHASE_C      COMP_INVERTINGINPUT_DAC2
#define COMPARATOR_PHASE_C_CSR  COMP_CSR_COMP2EN | COMP_CSR_COMP2INSEL_2 | COMP_CSR_COMP2INSEL_0
...
// adc calibration
#define ADC_VOLTAGE_OFFSET      90
#define ADC_VOLTAGE_FACTOR      1.425
