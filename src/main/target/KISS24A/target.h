...
// comparator ,Ok
//#define COMPARATOR_OPTIMIZE Ko, calculate CSRs
#define COMPARATOR              COMP2
#define COMPARATOR_PHASE_A      COMP_INVERTINGINPUT_DAC1
#define COMPARATOR_PHASE_A_CSR  COMP_CSR_COMP2EN | COMP_INVERTINGINPUT_DAC1
#define COMPARATOR_PHASE_B      COMP_INVERTINGINPUT_IO1
#define COMPARATOR_PHASE_B_CSR  COMP_CSR_COMP2EN | COMP_INVERTINGINPUT_IO1
#define COMPARATOR_PHASE_C      COMP_INVERTINGINPUT_DAC2
#define COMPARATOR_PHASE_C_CSR  COMP_CSR_COMP2EN | COMP_INVERTINGINPUT_DAC2
